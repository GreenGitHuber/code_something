        ...
        for item in self.available_trains: 
            ...
            if not self.options or initial in self.options:
                train = [
                            ...
                            '\n'.join([Fore.GREEN + cm[8] + Fore.RESET, Fore.RED + cm[9] + Fore.RESET]), 
                            cm[10], 
                            cm[32], 
                            cm[25], 
                            cm[31], 
